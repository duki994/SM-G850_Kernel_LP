 ...
 * @Reason	: August 2016   - HP_MEDIA_VOL adjusted for SM-G850F
 * 		: August 2016 - Main speaker gain control for SM-G850F exposed
...
#define DEF_HP_MEDIA_VOL	112 /* it's 114 hardcoded in default.conf */
